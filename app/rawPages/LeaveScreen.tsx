      ...
      <LinearGradient colors={["#F6E8FF", "#FAF5FF"]} style={styles.header}>
        <View style={styles.headerContent}>
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              setShowApplyForm((prev) => {
                if (prev) resetFormState();
                return !prev;
              });
            }}
          >
            ...
            <>
              ...
              <View style={styles.applyCard}>
                ...
                <TextInput
                  ...
                  style={[
                    styles.input,
                    { height: vs(80), textAlignVertical: "top" },
                  ]}
                  multiline
                  value={note}
                  onChangeText={setNote}
                />
                <View style={[{ paddingBottom: insets.bottom + vs(10) }]}>
                  <TouchableOpacity
              ...
              <StatusModal
                ...
                title={
                  modalType === "success"
                    ? "Pending for Leave Approval"
                    : "Something went wrong"
                }
                message={
                  modalType === "success"
                    ? "Admin will notify you regarding your leave approval."
                    : "Please fill all required fields before applying."
                }
                onClose={() => {
